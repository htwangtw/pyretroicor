...
from pyretroicor.util import bids_load_meta, bids_output_name, physio_time, tr_reference, save_tsv
...
def main():
    ...
    _, tr_idx = tr_reference(n_vol, func_meta["RepetitionTime"], time)
    ...
    # create output dir
    filepath = bids_output_name(PHYSIO_FILE, OUTDIR)
